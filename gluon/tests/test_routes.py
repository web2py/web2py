...
class TestRoutes(unittest.TestCase):
    ...
    def test_routes_null(self):
        ...
        self.assertEqual(filter_url("http://domain.com/abc/def/ghi/"), "/abc/def/ghi")
        self.assertEqual(
            filter_url("http://domain.com/abc/def/ghi/jkl"), "/abc/def/ghi ['jkl']"
        )
        self.assertEqual(
            filter_url("http://domain.com/abc/def/ghi/j%20kl"), "/abc/def/ghi ['j_kl']"
        )
        self.assertEqual(
...
"""
        ...
        self.assertEqual(
            filter_url("http://localhost:8000/service/person/create?var1=val1"),
...
"""
        ...
        self.assertEqual(
            filter_url("http://domain.com/welcome/static/abc"),
    ...
    def test_routes_raise(self):
        ...
        self.assertEqual(
            filter_url("http://domain.com/init/default"), "/init/default/index"
        )
        self.assertEqual(
            filter_url("http://domain.com/init/default/fcn.ext"),
            "/init/default/fcn.ext",
        )
        self.assertEqual(
            filter_url("http://domain.com/init/default/fcn/arg"),
...
"""
        ...
        self.assertEqual(
            str(URL(a="welcome", c="default", f="f", args=["arg1"])), "/f/arg1"
        )
        self.assertEqual(
            str(URL(a="welcome", c="default", f="f", args=["arg1", ""])), "/f/arg1//"
        )
        self.assertEqual(
            str(URL(a="welcome", c="default", f="f", args=["arg1", "", "arg3"])),
            "/f/arg1//arg3",
        )
        self.assertEqual(
            str(URL(a="welcome", c="default", f="f", args=["ar g"])), "/f/ar%20g"
        )
        self.assertEqual(
    ...
    def test_routes_anchor(self):
        ...
        query = dict(var="abc")
        self.assertEqual(
            str(URL(a="init", c="default", f="index", vars=query)), "/?var=abc"
        )
        self.assertEqual(
            str(URL(a="init", c="default", f="index", vars=query, anchor="anchor")),
            "/?var=abc#anchor",
        )
