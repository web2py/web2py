...
class TestAuthAPI(unittest.TestCase):
    ...
    def test_profile(self):
        ...
        self.assertTrue(
            self.auth.table_user()[result["user"]["id"]].email == "bartolo@simpson.com"
        )
    ...
    def test_change_password(self):
        ...
        self.assertTrue(self.auth.is_logged_in())
        self.auth.change_password(
            old_password="bart_password", new_password="1234", new_password2="1234"
        )
        self.auth.logout()
        self.assertTrue(not self.auth.is_logged_in())
        ...
        result = self.auth.change_password(
            old_password="bart_password", new_password="1234", new_password2="5678"
        )
        ...
        result = self.auth.change_password(
            old_password="1234", new_password="123", new_password2="123"
        )
