...
class TestRouter(unittest.TestCase):
    ...
    def test_router_syntax(self):
        ...
        self.myassertRaisesRegex(SyntaxError, "invalid syntax", load, data="x::y")
        self.myassertRaisesRegex(
            SyntaxError, "unknown key", load, rdict=dict(BASE=dict(badkey="value"))
        )
        self.myassertRaisesRegex(
            SyntaxError,
            "BASE-only key",
    ...
    def test_router_null(self):
        ...
        self.assertEqual(
            filter_url("http://domain.com/index/abc"), "/init/default/index ['abc']"
        )
        self.assertEqual(
            filter_url("http://domain.com/abc/def"), "/init/default/abc ['def']"
        )
        self.assertEqual(
            filter_url("http://domain.com/index/a%20bc"), "/init/default/index ['a bc']"
        )
        self.assertEqual(
            filter_url("http://domain.com/welcome/static/path/to/static").replace(
                "/", os.sep
            ),
            norm_root("%s/applications/welcome/static/path/to/static" % root),
        )
        self.assertRaises(
            HTTP, filter_url, "http://domain.com/welcome/static/bad/path/to/st~tic"
        )
        self.myassertRaisesRegex(
            HTTP,
            "400.*invalid static file",
            filter_url,
        ...
        self.assertEqual(
            filter_url("http://domain.com/init/static/abc", out=True),
            "/init/static/abc",
        )
        self.assertEqual(
            filter_url("http://domain.com/init/appadmin/index", out=True), "/appadmin"
        )
        self.assertEqual(
            filter_url("http://domain.com/init/appadmin/abc", out=True), "/appadmin/abc"
        )
        self.assertEqual(
            filter_url("http://domain.com/init/admin/index", out=True), "/init/admin"
        )
        self.assertEqual(
            filter_url("http://domain.com/init/admin/abc", out=True), "/init/admin/abc"
        )
        self.assertEqual(
            filter_url("http://domain.com/admin/default/abc", out=True), "/admin/abc"
        )
    ...
    def test_router_defapp(self):
        ...
        self.assertEqual(filter_url("http://domain.com/"), "/welcome/default/index")
        self.assertEqual(
            filter_url("http://domain.com/appadmin"), "/welcome/appadmin/index"
        )
        self.assertEqual(filter_url("http://domain.com/abc"), "/welcome/default/abc")
        self.assertEqual(
            filter_url("http://domain.com/index/abc"), "/welcome/default/index ['abc']"
        )
        self.assertEqual(
            filter_url("http://domain.com/abc/def"), "/welcome/default/abc ['def']"
        )
        self.assertEqual(
            filter_url("http://domain.com/favicon.ico"),
        ...
        self.assertEqual(
            filter_url("http://domain.com/static/abc"),
            norm_root("%s/applications/welcome/static/abc" % root),
        )
        self.assertEqual(
            filter_url("http://domain.com/static/path/to/static").replace("/", os.sep),
            norm_root("%s/applications/welcome/static/path/to/static" % root),
        )
        # outgoing
        self.assertEqual(
            filter_url("http://domain.com/welcome/default/index", out=True), "/"
        )
        self.assertEqual(
            filter_url("http://domain.com/welcome/default/index/arg1", out=True),
            "/index/arg1",
        )
        self.assertEqual(
            filter_url("http://domain.com/welcome/default/abc", out=True), "/abc"
        )
        self.assertEqual(
            filter_url("http://domain.com/welcome/default/admin", out=True),
            "/default/admin",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            filter_url("http://domain.com/welcome/appadmin/index", out=True),
            "/appadmin",
        )
        self.assertEqual(
            filter_url("http://domain.com/welcome/appadmin/abc", out=True),
            "/appadmin/abc",
        )
        self.assertEqual(
            filter_url("http://domain.com/welcome/admin/index", out=True),
            "/welcome/admin",
        )
        self.assertEqual(
            filter_url("http://domain.com/welcome/admin/abc", out=True),
            "/welcome/admin/abc",
        )
        self.assertEqual(
            filter_url("http://domain.com/admin/default/abc", out=True), "/admin/abc"
    ...
    def test_router_nodef(self):
        ...
        # outgoing
        self.assertEqual(
            filter_url("http://domain.com/welcome/default/index", out=True), "/default"
        )
        self.assertEqual(
            filter_url("http://domain.com/welcome/default/index/arg1", out=True),
            "/default/index/arg1",
        ...
        self.assertEqual(
            filter_url("http://domain.com/welcome/default/abc", out=True),
            "/default/abc",
        )
        self.assertEqual(
            filter_url("http://domain.com/welcome/static/abc", out=True),
        ...
        self.assertEqual(
            filter_url("http://domain.com/abc/def/ghi"), "/welcome/abc/def ['ghi']"
        )
        ...
        # outgoing
        self.assertEqual(
            filter_url("http://domain.com/welcome/default/index", out=True), "/welcome"
        )
        self.assertEqual(
            filter_url("http://domain.com/welcome/default/index/arg1", out=True),
            "/welcome/index/arg1",
        ...
        self.myassertRaisesRegex(
            HTTP, "400.*invalid application", filter_url, "http://domain.com"
        )
        self.myassertRaisesRegex(
            HTTP, "400.*invalid application", filter_url, "http://domain.com/appadmin"
        )
        routers = dict(
        ...
        self.myassertRaisesRegex(
            HTTP,
            "400.*unknown application: 'appadmin'",
            filter_url,
            "http://domain.com/appadmin",
        )
        routers = dict(
            BASE=dict(default_application="welcome", applications=None),
            welcome=dict(controllers=None),
        ...
        self.assertRaises(HTTP, filter_url, "http://domain.com/appadmin")
        self.myassertRaisesRegex(
            HTTP, "400.*invalid controller", filter_url, "http://domain.com"
        )
        self.myassertRaisesRegex(
            HTTP,
            "400.*unknown application: 'appadmin'",
        ...
        self.assertRaises(HTTP, filter_url, "http://domain.com/appadmin")
        self.myassertRaisesRegex(
            HTTP, "400.*invalid function", filter_url, "http://domain.com"
        )
        self.myassertRaisesRegex(
            HTTP,
            "400.*unknown application: 'appadmin'",
    ...
    def test_router_app(self):
        ...
        self.myassertRaisesRegex(
            HTTP, "400.*invalid application", filter_url, "http://domain.com/bad!app"
        )

        routers["BASE"]["domains"]["domain3.com"] = "app3"
        self.assertRaises(SyntaxError, load, rdict=routers)
        self.myassertRaisesRegex(SyntaxError, "unknown.*app3", load, rdict=routers)
    ...
    def test_router_domains(self):
        ...
        routers = dict(
            ...
            app2a=dict(
                default_controller="c2a",
                default_function="f2a",
                controllers=["c2a"],
            ),
            app2b=dict(
                default_controller="c2b",
                default_function="f2b",
                controllers=["c2b"],
            ),
            app3=dict(
                controllers=["c3a", "c3b"],
            ...
            app6=dict(
                default_controller="c6",
                default_function="f6",
                controllers=["c6"],
            ),
            app6s=dict(
                default_controller="c6s",
                default_function="f6s",
                controllers=["c6s"],
            ),
        )
        ...
        self.assertEqual(
            filter_url("http://domain1.com/index/abc"), "/app1/c1/index ['abc']"
        )
        self.assertEqual(filter_url("http://domain2.com/app1"), "/app1/c1/f1")

        self.assertEqual(
            filter_url(
                "https://domain1.com/app1/ctr/fcn", domain=("app1", None), out=True
            ),
            "/ctr/fcn",
        )
        self.assertEqual(
            filter_url(
                "https://www.domain1.com/app1/ctr/fcn", domain=("app1", None), out=True
            ),
            "/ctr/fcn",
        )
        ...
        self.assertEqual(
            filter_url(
                "http://domain2.com/app2a/ctr/fcn", domain=("app2a", None), out=True
            ),
            "/ctr/fcn",
        )
        self.assertEqual(
            filter_url(
                "http://domain2.com/app2a/ctr/f2a", domain=("app2a", None), out=True
            ),
            "/ctr",
        )
        self.assertEqual(
            filter_url(
                "http://domain2.com/app2a/c2a/f2a", domain=("app2a", None), out=True
            ),
            "/",
        )
        self.assertEqual(
            filter_url(
                "http://domain2.com/app2a/c2a/fcn", domain=("app2a", None), out=True
            ),
            "/fcn",
        )
        self.assertEqual(
            filter_url(
                "http://domain2.com/app2a/ctr/fcn", domain=("app2b", None), out=True
            ),
            "/app2a/ctr/fcn",
        )
        self.assertEqual(
            filter_url(
                "http://domain2.com/app2a/ctr/f2a", domain=("app2b", None), out=True
            ),
            "/app2a/ctr",
        )
        self.assertEqual(
            filter_url(
                "http://domain2.com/app2a/c2a/f2a", domain=("app2b", None), out=True
            ),
            "/app2a",
        )
        ...
        self.assertEqual(
            filter_url(
                "http://domain3a.com/app3/c3a/fcn", domain=("app3", "c3a"), out=True
            ),
            "/fcn",
        )
        self.assertEqual(
            filter_url(
                "http://domain3a.com/app3/c3a/fcn", domain=("app3", "c3b"), out=True
            ),
            "/c3a/fcn",
        )
        self.assertEqual(
            filter_url(
                "http://domain3a.com/app3/c3a/fcn", domain=("app1", None), out=True
            ),
            "/app3/c3a/fcn",
        )
        ...
        self.assertEqual(
            filter_url(
                "https://domain4a.com/app4/c4/fcn", domain=("app4", None), out=True
            ),
            "/fcn",
        )
        ...
        self.assertEqual(
            filter_url("http:///abc"), "/app5/c5/abc"
        )  # test null host => localhost
        self.assertEqual(
            filter_url(
                "https://localhost/app5/c5/fcn", domain=("app5", None), out=True
            ),
            "/fcn",
        )
        ...
        self.assertEqual(
            filter_url(
                "http://domain2.com/app3/c3a/f3", domain=("app2b", None), out=True
            ),
            "/app3/c3a/f3",
        )
        self.assertRaises(
    ...
    def test_router_domains_ed(self):
        ...
        self.assertRaises(
            SyntaxError,
            filter_url,
            "http://domain2.com/app2a/ctr/fcn",
            domain=("app2b", None),
            out=True,
        )
        self.assertRaises(
            SyntaxError,
            filter_url,
            "http://domain2.com/app2a/ctr/f2a",
            domain=("app2b", None),
            out=True,
        )
        self.assertRaises(
            SyntaxError,
            filter_url,
            "http://domain2.com/app2a/c2a/f2a",
            domain=("app2b", None),
            out=True,
        )
        ...
        self.assertRaises(
            SyntaxError,
            filter_url,
            "http://domain3a.com/app3/c3a/fcn",
            domain=("app1", None),
            out=True,
        )
    ...
    def test_router_raise(self):
        ...
        self.assertEqual(
            filter_url("http://domain.com/default/fcn.ext"), "/init/default/fcn.ext"
        )
        self.assertEqual(
            filter_url("http://domain.com/default/fcn/arg"), "/init/default/fcn ['arg']"
        )
        ...
        self.myassertRaisesRegex(
            HTTP,
            "400.*invalid controller",
            filter_url,
            "http://domain.com/init/bad!ctl",
        )
        self.myassertRaisesRegex(
            HTTP,
        ...
        self.assertEqual(
            filter_url("http://domain.com/welcome/default/fcn_1"),
    ...
    def test_router_out(self):
        ...
        self.assertEqual(
            filter_url("https://domain.com/app/ctr/fcn", out=True), "/app/ctr/fcn"
        )
        self.assertEqual(
            filter_url("https://domain.com/init/ctr/fcn", out=True), "/ctr/fcn"
        )
        self.assertEqual(
            filter_url("https://domain.com/init/ctr/fcn", out=True), "/ctr/fcn"
        )
        self.assertEqual(
            filter_url("https://domain.com/init/static/file", out=True),
            "/init/static/file",
        )
        self.assertEqual(
            filter_url("https://domain.com/init/static/index", out=True),
            "/init/static/index",
        )
        self.assertEqual(
            filter_url("https://domain.com/init/default/index", out=True), "/"
        )
        self.assertEqual(
            filter_url("https://domain.com/init/ctr/index", out=True), "/ctr"
        )
        self.assertEqual(
            filter_url("http://domain.com/init/default/fcn?query", out=True),
            "/fcn?query",
        )
        self.assertEqual(
            filter_url("http://domain.com/init/default/fcn#anchor", out=True),
            "/fcn#anchor",
        )
        self.assertEqual(
            filter_url("http://domain.com/init/default/fcn?query#anchor", out=True),
            "/fcn?query#anchor",
        )
        ...
        load(rdict=router_out)
        self.assertEqual(
            filter_url("https://domain.com/init/static/file", out=True), "/static/file"
        )
        self.assertEqual(
            filter_url("https://domain.com/init/static/index", out=True),
            "/static/index",
    ...
    def test_router_functions(self):
        ...
        # outbound
        self.assertEqual(
            str(URL(a="init", c="default", f="f", args=["arg1"])), "/init/f/arg1"
        )
        self.assertEqual(
            str(URL(a="init", c="default", f="index", args=["arg1"])),
            "/init/index/arg1",
        )
        ...
        self.assertEqual(
            str(URL(a="app", c="default", f="user", args=["arg1"])), "/user/arg1"
        )
        self.assertEqual(
            str(URL(a="app", c="default", f="user", args=["index"])), "/user/index"
        )
        self.assertEqual(
            str(URL(a="app", c="default", f="index", args=["index"])), "/index/index"
        )
        self.assertEqual(
            str(URL(a="app", c="default", f="index", args=["init"])), "/index/init"
        )
        self.assertEqual(
            str(URL(a="app", c="default", f="index", args=["ctr"])), "/index/ctr"
        )
        self.assertEqual(
            str(URL(a="app", c="ctr", f="index", args=["arg"])), "/ctr/index/arg"
        )
        self.assertEqual(
            str(URL(a="app", c="ctr", f="ctrf1", args=["arg"])), "/ctr/arg"
        )
        self.assertEqual(
            str(URL(a="app", c="ctr", f="ctrf1", args=["ctrf2"])), "/ctr/ctrf1/ctrf2"
        )

        self.assertEqual(
            str(URL(a="app2", c="default", f="index", args=["arg1"])), "/app2/arg1"
        )
        self.assertEqual(
            str(URL(a="app2", c="default", f="user", args=["arg1"])), "/app2/user/arg1"
        )
        self.assertEqual(
            str(URL(a="app2", c="default", f="user", args=["index"])),
            "/app2/user/index",
        )
        self.assertEqual(
            str(URL(a="app2", c="default", f="index", args=["index"])),
            "/app2/index/index",
        )
        self.assertEqual(
            str(URL(a="app2", c="default", f="index", args=["init"])),
            "/app2/index/init",
        )
        self.assertEqual(
            str(URL(a="app2", c="default", f="index", args=["ctr"])), "/app2/index/ctr"
        )

        # outbound - with extensions
        self.assertEqual(str(URL(a="app", c="default", f="index.json")), "/index.json")
        self.assertEqual(
            str(URL(a="app", c="default", f="index.json", args=["arg1"])),
            "/index.json/arg1",
        )
        self.assertEqual(str(URL(a="app", c="default", f="user.json")), "/user.json")
        self.assertEqual(
            str(URL(a="app", c="default", f="user.json", args=["arg1"])),
            "/user.json/arg1",
        )
        self.assertEqual(
            str(URL(a="app", c="default", f="user.json", args=["index"])),
            "/user.json/index",
        )
        self.assertEqual(
            str(URL(a="app", c="default", f="index.json", args=["ctr"])),
            "/index.json/ctr",
        )
        self.assertEqual(
            str(URL(a="app", c="ctr", f="ctrf1.json", args=["arg"])),
            "/ctr/ctrf1.json/arg",
        )

        self.assertEqual(
            str(URL(a="app2", c="default", f="index.json", args=["arg1"])),
            "/app2/index.json/arg1",
        )
        self.assertEqual(
            str(URL(a="app2", c="ctr", f="index.json", args=["arg1"])),
            "/app2/ctr/index.json/arg1",
        )
        ...
        self.assertEqual(
            filter_url("http://d.com/app2/arg"), "/app2/default/index ['arg']"
        )
        self.assertEqual(filter_url("http://d.com/app2/user"), "/app2/default/user")
        self.assertEqual(
            filter_url("http://d.com/app2/user/arg"), "/app2/default/user ['arg']"
        )
        self.assertEqual(filter_url("http://d.com/app2/ctr"), "/app2/ctr/index")
        self.assertEqual(
            filter_url("http://d.com/app2/ctr/index/arg"), "/app2/ctr/index ['arg']"
        )
        ...
        self.assertEqual(
            filter_url("http://d.com/user.json/index"),
            "/app/default/user.json ['index']",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            filter_url("http://d.com/app2/index.json/arg"),
            "/app2/default/index.json ['arg']",
        )
        self.assertEqual(
            filter_url("http://d.com/app2/user.json"), "/app2/default/user.json"
        )
        self.assertEqual(
            filter_url("http://d.com/app2/user.json/arg"),
            "/app2/default/user.json ['arg']",
        )
        self.assertEqual(
            filter_url("http://d.com/app2/ctr/index.json/arg"),
            "/app2/ctr/index.json ['arg']",
        )
        self.assertEqual(filter_url("http://d.com/app2/ctr/arg"), "/app2/ctr/arg")
    ...
    def test_router_functions2(self):
        ...
        # outbound
        self.assertEqual(
            str(URL(a="init", c="default", f="index", args=["arg1"])), "/arg1"
        )
        self.assertEqual(
            str(URL(a="init", c="default", f="user", args=["arg1"])), "/user/arg1"
        )
        self.assertEqual(
            str(URL(a="init", c="default", f="user", args=["index"])), "/user/index"
        )
        self.assertEqual(
            str(URL(a="init", c="default", f="index", args=["index"])), "/index/index"
        )
        self.assertEqual(
            str(URL(a="init", c="default", f="index", args=["init"])), "/init"
        )
        self.assertEqual(
            str(URL(a="init", c="default", f="index", args=["ctr"])), "/index/ctr"
        )
        self.assertEqual(
            str(URL(a="init", c="ctr", f="index", args=["arg"])), "/ctr/index/arg"
        )
        self.assertEqual(
            str(URL(a="init", c="ctr", f="ctrf1", args=["arg"])), "/ctr/ctrf1/arg"
        )
        self.assertEqual(
            str(URL(a="init", c="ctr", f="ctrf1", args=["ctrf2"])), "/ctr/ctrf1/ctrf2"
        )
        ...
        self.assertEqual(
            filter_url("http://d.com/ctr/ctrf1/arg"), "/init/ctr/ctrf1 ['arg']"
        )
    ...
    def test_router_hyphen(self):
        ...
        self.assertEqual(
            filter_url("http://domain.com/init/default/fcn_1", out=True), "/fcn_1"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            filter_url(
                "http://domain.com/init/static/filename-with_underscore", out=True
            ),
            "/init/static/filename-with_underscore",
        )

        self.assertEqual(
            filter_url("http://domain.com/app2/fcn_1"), "/app2/default/fcn_1"
        )
        self.assertEqual(
            filter_url(
                "http://domain.com/app2/ctr/fcn_1", domain=("app2", None), out=True
            ),
            "/ctr/fcn_1",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            filter_url("http://domain.com/app2/static/filename-with_underscore"),
    ...
    def test_router_lang(self):
        ...
        self.assertEqual(
            filter_url("http://domain.com/index/a%20bc"),
            "/admin/default/index ['a bc'] (en)",
        )
        self.assertEqual(
            filter_url("http://domain.com/static/file"),
            norm_root("%s/applications/admin/static/file" % root),
        )
        self.assertEqual(
            filter_url("http://domain.com/en/static/file"),
            norm_root("%s/applications/admin/static/file" % root),
        )
        self.assertEqual(
            filter_url("http://domain.com/examples/en/static/file"),
            norm_root("%s/applications/examples/static/en/file" % root),
        )
        self.assertEqual(
            filter_url("http://domain.com/examples/static/file"),
            norm_root("%s/applications/examples/static/en/file" % root),
        )
        self.assertEqual(
            filter_url("http://domain.com/examples/it/static/file"),
            norm_root("%s/applications/examples/static/it/file" % root),
        )
        self.assertEqual(
            filter_url("http://domain.com/examples/it-it/static/file"),
            norm_root("%s/applications/examples/static/file" % root),
        )

        self.assertEqual(
            filter_url("https://domain.com/admin/ctr/fcn", lang="en", out=True),
            "/ctr/fcn",
        )
        self.assertEqual(
            filter_url("https://domain.com/admin/ctr/fcn", lang="it", out=True),
            "/it/ctr/fcn",
        )
        self.assertEqual(
            filter_url("https://domain.com/admin/ctr/fcn", lang="it-it", out=True),
            "/it-it/ctr/fcn",
        )
        self.assertEqual(
            filter_url("https://domain.com/admin/static/file", lang="en", out=True),
            "/admin/en/static/file",
        )
        self.assertEqual(
            filter_url("https://domain.com/admin/static/file", lang="it", out=True),
            "/admin/it/static/file",
        )
        self.assertEqual(
            filter_url("https://domain.com/admin/static/file", lang="it-it", out=True),
            "/admin/it-it/static/file",
        )
        self.assertEqual(
            filter_url("https://domain.com/welcome/ctr/fcn", lang="it", out=True),
            "/welcome/ctr/fcn",
        )
        self.assertEqual(
            filter_url("https://domain.com/welcome/ctr/fcn", lang="es", out=True),
            "/welcome/ctr/fcn",
        )

        self.assertEqual(
            filter_url("https://domain.com/admin/ctr/fcn", language="en", out=True),
            "/ctr/fcn",
        )
        self.assertEqual(
            filter_url("https://domain.com/admin/ctr/fcn", language="it", out=True),
            "/it/ctr/fcn",
        )
        self.assertEqual(
            filter_url("https://domain.com/admin/ctr/fcn", language="it-it", out=True),
            "/it-it/ctr/fcn",
        )
        self.assertEqual(
            filter_url("https://domain.com/admin/static/file", language="en", out=True),
            "/admin/en/static/file",
        )
        self.assertEqual(
            filter_url("https://domain.com/admin/static/file", language="it", out=True),
            "/admin/it/static/file",
        )
        self.assertEqual(
            filter_url(
                "https://domain.com/admin/static/file", language="it-it", out=True
            ),
            "/admin/it-it/static/file",
        )
        self.assertEqual(
            filter_url("https://domain.com/welcome/ctr/fcn", language="it", out=True),
            "/welcome/ctr/fcn",
        )
        self.assertEqual(
            filter_url("https://domain.com/welcome/ctr/fcn", language="es", out=True),
            "/welcome/ctr/fcn",
        )

        self.assertEqual(
            filter_url(
                "https://domain.com/admin/ctr/fcn", lang="it", language="en", out=True
            ),
            "/ctr/fcn",
        )
        self.assertEqual(
            filter_url(
                "https://domain.com/admin/ctr/fcn", lang="en", language="it", out=True
            ),
            "/it/ctr/fcn",
        )
        self.assertEqual(
            filter_url(
                "https://domain.com/admin/ctr/fcn",
                lang="it",
                language="it-it",
                out=True,
            ),
        ...
        self.assertEqual(
            filter_url(
                "https://domain.com/admin/static/file",
                lang="it",
                language="en",
                out=True,
            ),
        ...
        self.assertEqual(
            filter_url(
                "https://domain.com/welcome/ctr/fcn", lang="it", language="it", out=True
            ),
            "/welcome/ctr/fcn",
        )
        self.assertEqual(
            filter_url(
                "https://domain.com/welcome/ctr/fcn", lang="it", language="es", out=True
            ),
            "/welcome/ctr/fcn",
        )
        ...
        self.assertEqual(
            filter_url("https://domain.com/admin/static/file", lang="en", out=True),
            "/admin/static/en/file",
        )
        self.assertEqual(
            filter_url("https://domain.com/admin/static/file", lang="it", out=True),
            "/admin/static/it/file",
        )
        self.assertEqual(
            filter_url("https://domain.com/admin/static/file", lang="it-it", out=True),
            "/admin/static/it-it/file",
        )
        self.assertEqual(
            filter_url("https://domain.com/welcome/ctr/fcn", lang="it", out=True),
            "/welcome/ctr/fcn",
        ...
        self.assertEqual(
            filter_url("http://domain.com/examples/static/en/file").replace(
                "/", os.sep
            ),
            norm_root("%s/applications/examples/static/en/file" % root),
        )
        self.assertEqual(
            filter_url("http://domain.com/examples/static/it/file").replace(
                "/", os.sep
            ),
            norm_root("%s/applications/examples/static/it/file" % root),
        )
        self.assertEqual(
            filter_url("http://domain.com/examples/static/it-it/file").replace(
                "/", os.sep
            ),
    ...
    def test_router_get_effective(self):
        ...
        self.assertEqual(
            get_effective_router("a1").controllers,
            set(["c1a", "c1b", "default", "static"]),
        )
        ...
        self.assertEqual(
            get_effective_router("a4").functions, dict(default=set(["f1", "f2"]))
        )
    ...
    def test_router_static_path(self):
        ...
        self.assertEqual(
            filter_url("http://domain.com/welcome/static/path/-+=@$%/static").replace(
                "/", os.sep
            ),
            norm_root("%s/applications/welcome/static/path/-+=@$%%/static" % root),
        )
        self.assertRaises(
            HTTP, filter_url, "http://domain.com/welcome/static/bad/path/to/.static"
        )
        self.assertRaises(
            HTTP, filter_url, "http://domain.com/welcome/static/bad/path/to/s..tatic"
        )
        self.assertRaises(
            HTTP, filter_url, "http://domain.com/welcome/static/bad/path/to//static"
        )
        ...
        self.assertRaises(
            HTTP, filter_url, "http://domain.com/welcome/static/bad/path/./static"
        )
        self.assertRaises(
            HTTP, filter_url, "http://domain.com/welcome/static/bad/path/../static"
        )
    ...
    def test_router_args(self):
        ...
        load(rdict=dict())
        self.assertEqual(
            filter_url("http://domain.com/init/default/f/arg1"),
            "/init/default/f ['arg1']",
        )
        self.assertEqual(
            filter_url("http://domain.com/init/default/f/arg1/"),
        ...
        self.assertEqual(
            map_url_out(
                None, None, "init", "default", "f", None, None, None, None, None
            ),
            "/f",
        )
        self.assertEqual(
            map_url_out(None, None, "init", "default", "f", [], None, None, None, None),
            "/f",
        )
        self.assertEqual(
            map_url_out(
                None, None, "init", "default", "f", ["arg1"], None, None, None, None
            ),
            "/f",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            str(URL(a="init", c="default", f="f", args=["arg1", "", "arg3"])),
            "/f/arg1//arg3",
        )
        self.assertEqual(
            str(URL(a="init", c="default", f="f", args=["ar g"])), "/f/ar%20g"
        )
        self.assertEqual(
    ...
    def test_routes_anchor(self):
        ...
        self.assertEqual(
            str(URL(a="a", c="c", f="f", args=args, vars=vars, anchor="anchor")),
            "/a/c/f/a1/a2?v1=1&v2=2#anchor",
        )
        self.assertEqual(str(URL(a="init", c="default", f="index")), "/")
        self.assertEqual(str(URL(a="init", c="default", f="f")), "/f")
        self.assertEqual(
            str(URL(a="init", c="default", f="index", anchor="anchor")), "/#anchor"
        )
        self.assertEqual(
            str(URL(a="init", c="default", f="f", anchor="anchor")), "/f#anchor"
        )
    ...
    def test_router_prefix(self):
        ...
        self.assertEqual(str(URL(a="a1", c="c1a", f="f")), "/path/to/apps/c1a/f")
        self.assertEqual(str(URL(a="a2", c="c", f="f")), "/path/to/apps/a2/c/f")
        self.assertEqual(str(URL(a="a2", c="c2", f="f")), "/path/to/apps/a2/c2/f")
        self.assertEqual(filter_url("http://domain.com/a1/"), "/a1/default/index")
        self.assertEqual(
            filter_url("http://domain.com/path/to/apps/a1/"), "/a1/default/index"
        )
        self.assertEqual(
            filter_url("http://domain.com/path/to/a1/"), "/a1/default/path ['to', 'a1']"
        )
    ...
    def test_router_absolute(self):
        ...
        self.assertEqual(
            str(URL(r=r, a="a", c="c", f="f", host="host.com")),
            "httpx://host.com/a/c/f",
        )
        self.assertEqual(
            str(URL(r=r, a="a", c="c", f="f", scheme=True)), "httpx://domain.com/a/c/f"
        )
        self.assertEqual(str(URL(r=r, a="a", c="c", f="f", scheme=False)), "/a/c/f")
        self.assertEqual(
            str(URL(r=r, a="a", c="c", f="f", scheme="https")),
            "https://domain.com/a/c/f",
        )
        self.assertEqual(
            str(URL(r=r, a="a", c="c", f="f", scheme="wss")), "wss://domain.com/a/c/f"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            str(URL(r=r, a="a", c="c", f="f", port=1234)),
        ...
        self.assertEqual(
            str(
                URL(r=r, a="a", c="c", f="f", scheme="wss", host="host.com", port=1234)
            ),
    ...
    def test_request_collide(self):
        ...
        self.assertEqual(
            filter_url(
                "http://ex.domain.com/examples/default/exdef",
                domain="examples",
                out=True,
            ),
            "/",
        ...
        self.assertEqual(
            filter_url(
                "http://ad.domain.com/admin/default/index", domain="admin", out=True
            ),
            "/",
        )
        self.assertEqual(
            filter_url(
                "http://welcome.com/welcome/default/index", domain="welcome", out=True
            ),
            "/",
        )
        self.assertEqual(
            filter_url(
                "http://www.welcome.com/welcome/default/index",
                domain="welcome",
                out=True,
            ),
            "/",
        ...
        self.assertEqual(
            filter_url(
                "http://welcome.com/welcome/other/index", domain="welcome", out=True
            ),
            "/other",
        )
        self.assertEqual(
            filter_url(
                "http://welcome.com/welcome/admin/index", domain="welcome", out=True
            ),
            "/admin",
        )
        self.assertEqual(
            filter_url(
                "http://ad.domain.com/admin/shell/index", domain="admin", out=True
            ),
            "/shell",
        )
        self.assertEqual(
            filter_url(
                "http://ad.domain.com/admin/default/f1", domain="admin", out=True
            ),
            "/f1",
        )
