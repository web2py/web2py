...
class TestUtils(unittest.TestCase):
    ...
    def test_simple_hash(self):
        ...
        self.assertRaises(
            RuntimeError, simple_hash, "web2py rocks!", key="", salt="", digest_alg=None
        )
        ...
        self.assertEqual(
            data_sha224, "84d7054271842c2c17983baa2b1447e0289d101140a8c002d49d60da"
        )
    ...
    def test_is_valid_ip_address(self):
        ...
        # Compressed
        self.assertEqual(
            is_valid_ip_address("::ffff:7f00:1"), True
        )  # IPv6 127.0.0.1 compressed
        self.assertEqual(is_valid_ip_address("2001:660::1"), True)
        # Expanded
        self.assertEqual(
            is_valid_ip_address("0:0:0:0:0:ffff:7f00:1"), True
        )  # IPv6 127.0.0.1 expanded
        self.assertEqual(
            is_valid_ip_address("2607:fa48:6d50:69f1:21f:3cff:fe9d:9be3"), True
        )  # Any address
        # False
