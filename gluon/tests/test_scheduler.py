...
sched = Scheduler(sched_dal, max_empty_runs=10, migrate=False, heartbeat=1)
            """
...
""")
    ...
    def testRetryFailed(self):
        ...
        failed_consecutive = s.queue_task('demo8', task_name='retry_failed_consecutive', retry_failed=2, repeats=2, period=5)
        self.db.commit()
        self.writefunction(r"""
