...
'**not available** (requires the Python [[guppy http://pypi.python.org/pypi/guppy/ popup]] library)': '**não disponível** (requer a biblioteca [[guppy http://pypi.python.org/pypi/guppy/ popup]] do Python)',
'?': '?',
'@markmin\x01An error occured, please [[reload %s]] the page': 'Ocorreu um erro, por favor [[reload %s]] a página',
'``**not available**``:red (requires the Python [[guppy http://pypi.python.org/pypi/guppy/ popup]] library)': '``**não disponível**``:red (requer a biblioteca [[guppy http://pypi.python.org/pypi/guppy/ popup]] do Python)',
'About': 'Sobre',
...
'An error occured, please [[reload %s]] the page': 'Um erro ocorreu, por favor [[recarregue %s]]',
...
'Cache contains items up to **%(hours)02d** %%{hour(hours)} **%(min)02d** %%{minute(min)} **%(sec)02d** %%{second(sec)} old.': 'Cache contém itens de até **%(horas)02d** %%{hour(hours)} **%(min)02d** %%{minute(min)} **%(seg)02d** %%{second(sec)}.',
...
'DISK contains items up to **%(hours)02d** %%{hour(hours)} **%(min)02d** %%{minute(min)} **%(sec)02d** %%{second(sec)} old.': 'DISCO contém itens de até **%(horas)02d** %%{hour(hours)} **%(min)02d** %%{minute(min)} **%(seg)02d** %%{second(sec)} .',
...
'Helping web2py': 'Ajudando o  Web2py',
'Hit Ratio: **%(ratio)s%%** (**%(hits)s** %%{hit(hits)} and **%(misses)s** %%{miss(misses)})': 'Taxa de Hit: **%(ratio)s%%** (**%(hits)s** %%{hit(hits)} and **%(misses)s** %%{miss(misses)})',
'Home': 'Principal',
...
'RAM': 'RAM',
'RAM Cache Keys': 'Cahves de Cahce RAM',
'Ram Cleared': 'Ram limpada',
'RAM contains items up to **%(hours)02d** %%{hour(hours)} **%(min)02d** %%{minute(min)} **%(sec)02d** %%{second(sec)} old.': 'RAM contém itens de até **%(horas)02d** %%{hour(hours)} **%(min)02d** %%{minute(min)} **%(seg)02d** %%{second(sec)} old.',
'Recipes': 'Receitas',
'Record': 'Registro',
